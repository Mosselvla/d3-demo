...
export class Tree {
  ...
  private getStrokeColor(
    ...
    if (this.selectColor.value === 'rdylbu') {
      return d3.interpolateRdYlBu(depth / this.depth);
    }
    if (this.selectColor.value === 'rdylgn') {
      return d3.interpolateRdYlGn(depth / this.depth);
    }
